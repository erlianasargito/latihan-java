        ...
        do {
            ...
            switch (main.terpilih) {
                ...
                case "4":
                    ...
                    System.out.println("Masukkan tinggi:");
                    main.tinggi = main.inp.nextInt();
                    System.out.println("Masukkan sisi samping:");
                    main.sisi = main.inp.nextInt();
                    System.out.println("Masukkan tinggi prisma:");
                    main.tprisma = main.inp.nextInt();
                    main.inp.nextLine();

                    prisma = new Prisma(main.alas, main.tinggi, main.sisi, main.tprisma);
                    prisma.menggambarBangun();
                    prisma.getSegitiga();
